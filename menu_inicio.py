...
Label(MenuInicio,text="Bienvenido al inicio de sesión del hospital",font=("Arial Bold",16)).place(x=190,y=55)

Label(MenuInicio,text="Por favor ingresar lo siguiente",font=("Arial",14)).place(x=255,y=150)

Label(MenuInicio,text="Ingrese su número de cédula",font=(16)).place(x=25,y=250)
cedula=Entry(MenuInicio)
cedula.place(x=250,y=255)

Label(MenuInicio,text="Digite su contraseña",font=(16)).place(x=460,y=250)
contraseña=Entry(MenuInicio)
contraseña.place(x=630,y=255)

etiquta2=Label(MenuInicio)
etiquta2.place(x=660,y=355)
etiquta3=Label(MenuInicio)
etiquta3.place(x=680,y=375)
...
def presionar():
    ...
    """cedulalogIn=cedula.get()
    contraseñalogIn=contraseña.get()
    if cedulalogIn == "" and contraseñalogIn == "":
        print("Una o ambas estan vacias")
    else:
        etiquta2.config(text=cedulalogIn)
        etiquta3.config(text=co)
        print("Entra a doctores o pacientes")"""



boton=Button(MenuInicio,text="Haz click aquí",command=presionar).place(x=360,y=310)
